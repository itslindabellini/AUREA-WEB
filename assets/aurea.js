  ...
  function buildMobileMenu() {
    ...
    drawer.innerHTML =
      '<div style="display:flex;align-items:center;justify-content:space-between;padding:26px;border-bottom:1px solid #EFEAE2;">' +
        '<span style="font-family:Georgia,serif,Georgia,serif;font-weight:500;font-size:21px;color:#111;">Menu</span>' +
  ...
  function cartDrawer() {
    ...
    function headerHtml(count) {
      return '<div style="display:flex;align-items:center;justify-content:space-between;padding:26px 30px;border-bottom:1px solid #EFEAE2;flex:0 0 auto;">' +
        '<div style="font-family:Georgia,serif,Georgia,serif;font-weight:500;font-size:22px;color:#111;">Votre panier <span style="font-family:Manrope;font-weight:500;font-size:14px;color:#9A948C;">(' + count + ')</span></div>' +
    ...
    function emptyHtml() {
      return '<div style="flex:1 1 0%;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:40px;text-align:center;">' +
        ...
        '<div style="font-family:Georgia,serif,Georgia,serif;font-weight:500;font-size:20px;color:#111;margin-bottom:10px;">Votre panier est vide</div>' +
    ...
    function bannerHtml(pct) {
      return '<div style="margin-bottom:20px;background:#F5F0EB;padding:16px 18px;display:flex;align-items:center;gap:12px;">' +
        '<span style="font-family:Georgia,serif,Georgia,serif,Georgia,serif;font-weight:600;font-size:18px;color:#111;">' + pct + '%</span>' +
