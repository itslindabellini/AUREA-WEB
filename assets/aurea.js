...
(function () {
  ...
  var FAQ = [
    { q: 'Are the clothes true to size?',
      a: 'Yes, our clothes are designed to fit true to size. To ensure the best possible fit, we recommend checking our Size Guide on each product page before placing your order. As every style and body is unique, comparing your measurements with our size chart is the best way to find your perfect fit.' },
